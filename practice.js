...
// Create a function called MakePerson which takes in name, birthday, ssn as its parameters and returns a new object with all of the information 
//that you passed in.
...
*/
  ...
  function bindCard(person, creditcard) {
    ...
    for (var prop in person) {
      obj3[prop] = person[prop];
    }
    for (var prop in creditcard) {
      obj3[prop] = creditcard[prop];
    }
    return obj3;
  }
